(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))i(s);new MutationObserver(s=>{for(const n of s)if(n.type==="childList")for(const r of n.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&i(r)}).observe(document,{childList:!0,subtree:!0});function t(s){const n={};return s.integrity&&(n.integrity=s.integrity),s.referrerPolicy&&(n.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?n.credentials="include":s.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function i(s){if(s.ep)return;s.ep=!0;const n=t(s);fetch(s.href,n)}})();const w="modulepreload",b=function(a,e){return new URL(a,e).href},f={},x=function(e,t,i){let s=Promise.resolve();if(t&&t.length>0){const r=document.getElementsByTagName("link"),u=document.querySelector("meta[property=csp-nonce]"),l=(u==null?void 0:u.nonce)||(u==null?void 0:u.getAttribute("nonce"));s=Promise.allSettled(t.map(c=>{if(c=b(c,i),c in f)return;f[c]=!0;const d=c.endsWith(".css"),p=d?'[rel="stylesheet"]':"";if(!!i)for(let h=r.length-1;h>=0;h--){const g=r[h];if(g.href===c&&(!d||g.rel==="stylesheet"))return}else if(document.querySelector(`link[href="${c}"]${p}`))return;const m=document.createElement("link");if(m.rel=d?"stylesheet":w,d||(m.as="script"),m.crossOrigin="",m.href=c,l&&m.setAttribute("nonce",l),document.head.appendChild(m),d)return new Promise((h,g)=>{m.addEventListener("load",h),m.addEventListener("error",()=>g(new Error(`Unable to preload CSS for ${c}`)))})}))}function n(r){const u=new Event("vite:preloadError",{cancelable:!0});if(u.payload=r,window.dispatchEvent(u),!u.defaultPrevented)throw r}return s.then(r=>{for(const u of r||[])u.status==="rejected"&&n(u.reason);return e().catch(n)})},o={ads:{rotationIntervalMs:2e4,textAdFallback:!0,adFolder:"./assets/images/ads/",supportedFormats:[".jpg",".jpeg",".png",".webp"],adMessages:{"join-queue-premium-member.jpg":{title:"🎯 Premium Queue Membership",message:`Congratulations! You've discovered the secret to queue enlightenment.
...
`+this.currentAdData.disclaimer,buttonText:"OK"},this.showAdPopup(e),window.gameAchievements&&window.gameAchievements.triggerAdClick()}showAdPopup(e){const t=document.createElement("div");t.style.cssText=`
        ...
        `,document.body.appendChild(t),t.addEventListener("click",()=>{t.remove()})}pause(){this.isPaused=!0,this.rotationInterval&&(clearInterval(this.rotationInterval),this.rotationInterval=null),console.log("Ad system paused")}resume(){this.isPaused=!1,this.ads.length>0&&this.startRotation(),console.log("Ad system resumed")}destroy(){this.rotationInterval&&clearInterval(this.rotationInterval)}}class C{constructor(){this.audioContext=null,this.sounds={},this.currentTheme="basic",this.isMuted=!1,this.volume=o.audio.soundEffectsVolume,this.backgroundMusic=null,this.isBackgroundMusicPlaying=!1,this.wasPlayingBeforeMute=!1,this.themeAudio={basic:{background:"./assets/sounds/basic-ambient.mp3",beep:"./assets/sounds/basic-beep.mp3",notification:"./assets/sounds/basic-notification.mp3"},fancy:{background:"./assets/sounds/elevator-music.mp3",beep:"./assets/sounds/fancy-chime.mp3",notification:"./assets/sounds/reception-bell.mp3"},action:{background:"./assets/sounds/action-music.mp3",beep:"./assets/sounds/military-beep.mp3",notification:"./assets/sounds/explosion.mp3"},space:{background:"./assets/sounds/space-ambient.mp3",beep:"./assets/sounds/space-beep.mp3",notification:"./assets/sounds/alien-sound.mp3"},battle:{background:"./assets/sounds/battle-music.mp3",beep:"./assets/sounds/battle-horn.mp3",notification:"./assets/sounds/victory-sound.mp3"},mystical:{background:"./assets/sounds/mystical-ambient.mp3",beep:"./assets/sounds/meditation-bell.mp3",notification:"./assets/sounds/mystical-chime.mp3"},infinite:{background:"./assets/sounds/matrix-ambient.mp3",beep:"./assets/sounds/glitch-beep.mp3",notification:"./assets/sounds/digital-noise.mp3"}}}async init(){try{return this.audioContext=new(window.AudioContext||window.webkitAudioContext),await this.loadThemeSounds("basic"),this.loadDefaultBackgroundMusic().catch(e=>{console.warn("Background music failed to load:",e)}),this.setupUserInteractionListeners(),console.log("Audio Manager initialized"),!0}catch(e){return console.warn("Audio initialization failed:",e),!1}}async loadThemeSounds(e){if(this.themeAudio[e]){this.themeAudio[e];try{this.sounds[e]={background:this.createPlaceholderAudio("background",e),beep:this.createPlaceholderAudio("beep",e),notification:this.createPlaceholderAudio("notification",e)},console.log(`Audio loaded for theme: ${e}`)}catch(t){console.warn(`Failed to load audio for theme ${e}:`,t)}}}createPlaceholderAudio(e,t){return{play:()=>{console.log(`[Audio] Playing ${e} sound for ${t} theme`)},stop:()=>{console.log(`[Audio] Stopping ${e} sound for ${t} theme`)},setVolume:i=>{console.log(`[Audio] Setting ${e} volume to ${i}`)}}}async setTheme(e){var t,i;e!==this.currentTheme&&(console.log(`Switching audio theme from ${this.currentTheme} to ${e}`),(t=this.sounds[this.currentTheme])!=null&&t.background&&this.sounds[this.currentTheme].background.stop(),this.currentTheme=e,this.sounds[e]||await this.loadThemeSounds(e),!this.isMuted&&((i=this.sounds[e])!=null&&i.background)&&this.sounds[e].background.play())}playSound(e){var i;if(this.isMuted)return;const t=(i=this.sounds[this.currentTheme])==null?void 0:i[e];t&&(t.setVolume(this.volume),t.play())}playPositionUpdate(){this.playSound("beep")}playQueueEvent(){this.playSound("notification")}playQueueComplete(){this.playSound("notification"),setTimeout(()=>{this.playSound("beep")},500)}playAchievement(){this.playSound("notification")}async loadDefaultBackgroundMusic(){try{return this.backgroundMusic&&(this.backgroundMusic.pause(),this.backgroundMusic=null),this.backgroundMusic=new Audio,this.backgroundMusic.preload="none",this.backgroundMusic.loop=!0,this.backgroundMusic.volume=o.audio.backgroundMusicVolume,this.backgroundMusic.src=o.audio.backgroundMusicFile,console.log("Background music configured:",{src:this.backgroundMusic.src,volume:this.backgroundMusic.volume,loop:this.backgroundMusic.loop}),this.backgroundMusic.addEventListener("error",e=>{console.error("Audio error:",e),console.error("Audio error details:",{error:this.backgroundMusic.error,networkState:this.backgroundMusic.networkState,readyState:this.backgroundMusic.readyState})}),this.backgroundMusic.addEventListener("canplaythrough",()=>{console.log("Audio can play through")}),this.backgroundMusic.addEventListener("loadstart",()=>{console.log("Audio load started")}),!0}catch(e){return console.warn("Failed to configure background music:",e),!1}}async ensureMusicLoaded(){if(!this.backgroundMusic)return!1;if(this.backgroundMusic.readyState===0){console.log("Loading background music...");try{await new Promise((e,t)=>{this.backgroundMusic.oncanplaythrough=e,this.backgroundMusic.onerror=t,this.backgroundMusic.load()}),console.log("Background music loaded successfully")}catch(e){return console.warn("Failed to load background music:",e),!1}}return!0}async playBackgroundMusic(){if(!(!this.backgroundMusic||this.isMuted||!await this.ensureMusicLoaded()))try{await this.backgroundMusic.play(),this.isBackgroundMusicPlaying=!0,console.log("Background music started"),localStorage.setItem("musicEnabled","true")}catch(t){t.name==="NotAllowedError"?(console.log("Music blocked by browser autoplay policy - user interaction required"),localStorage.setItem("musicBlocked","true")):console.warn("Failed to play background music:",t)}}pauseBackgroundMusic(){this.backgroundMusic&&(this.backgroundMusic.pause(),this.isBackgroundMusicPlaying=!1,this.musicStatusIndicator&&this.updateMusicStatus(this.musicStatusIndicator))}stopBackgroundMusic(){this.backgroundMusic&&(this.backgroundMusic.pause(),this.backgroundMusic.currentTime=0,this.isBackgroundMusicPlaying=!1)}setVolume(e){this.volume=Math.max(0,Math.min(1,e)),Object.values(this.sounds).forEach(t=>{Object.values(t).forEach(i=>{i.setVolume(this.volume)})}),this.backgroundMusic&&(this.backgroundMusic.volume=o.audio.backgroundMusicVolume)}toggleMute(){var e;return this.isMuted=!this.isMuted,this.isMuted?(this.wasPlayingBeforeMute=this.isBackgroundMusicPlaying,Object.values(this.sounds).forEach(t=>{Object.values(t).forEach(i=>{i.stop()})}),this.pauseBackgroundMusic(),console.log("Audio muted, was playing before:",this.wasPlayingBeforeMute)):((e=this.sounds[this.currentTheme])!=null&&e.background&&this.sounds[this.currentTheme].background.play(),this.backgroundMusic?(console.log("Starting background music after unmute"),localStorage.removeItem("musicBlocked"),this.playBackgroundMusic()):console.log("No background music available to start")),this.musicStatusIndicator&&this.updateMusicStatus(this.musicStatusIndicator),console.log(`Audio ${this.isMuted?"muted":"unmuted"}`),this.isMuted}createAudioControls(){const e=document.createElement("div");e.style.cssText=`
            position: fixed;
            bottom: 20px;
            right: 20px;
            display: flex;
            ...
            z-index: 100;
            min-width: 200px;
        `;const t=document.createElement("div");t.id="music-status-indicator",t.style.cssText=`
            font-size: 11px;
            color: var(--text-secondary);
            text-align: center;
            margin-bottom: 5px;
        `,this.updateMusicStatus(t);const i=document.createElement("div");i.style.cssText=`
            display: flex;
            gap: 10px;
            align-items: center;
        `;const s=document.createElement("button");s.innerHTML=this.isMuted?"🔇":"🔊",s.title=this.isMuted?"Unmute Audio":"Mute Audio",s.style.cssText=`
            background: none;
            border: 1px solid var(--border-color);
        ...
        `,s.addEventListener("click",()=>{const l=this.toggleMute();s.innerHTML=l?"🔇":"🔊",s.title=l?"Unmute Audio":"Mute Audio",this.updateMusicStatus(t),this.musicToggleButton&&(this.musicToggleButton.style.opacity=this.isBackgroundMusicPlaying?"1":"0.5"),setTimeout(()=>{e.style.display="none"},1500)});const n=document.createElement("button");n.innerHTML="🎵",n.title="Toggle Background Music",n.style.cssText=`
            background: none;
            border: 1px solid var(--border-color);
            color: var(--text-primary);
            padding: 6px 10px;
        ...
        `,document.head.appendChild(e)}setThemeWithEffects(e){this.setTheme(e),setTimeout(()=>{this.addParticleEffects(e)},this.transitionDuration)}destroy(){this.clearParticleEffects();const e=document.getElementById("theme-animations");e&&e.remove()}}const I=[{id:1,title:"Queue Game Reaches 1 Million Players",content:"The revolutionary waiting experience has captivated audiences worldwide. 'It's like real life, but more frustrating,' says one satisfied customer.",category:"milestone",timestamp:"2025-09-15T10:30:00Z"},{id:2,title:"New Queue Skip Pro™ Features Announced",content:"Premium members can now skip to position 49,999 instead of 50,000! Scientists are calling it 'technically an improvement.'",category:"product",timestamp:"2025-09-14T15:45:00Z"},{id:3,title:"Local Man Achieves Queue Enlightenment",content:"After 47 hours in Queue Game, Jerry from Ohio reports: 'I no longer feel the passage of time. This is either transcendence or a medical emergency.'",category:"community",timestamp:"2025-12-13T09:20:00Z"},{id:4,title:"Queue Anxiety Pills Show Promising Results",content:"Clinical trials reveal 73% of users report reduced anxiety while waiting. Side effects may include increased patience and existential dread.",category:"health",timestamp:"2025-12-12T14:15:00Z"},{id:5,title:"Breaking: Queue Position Algorithms Updated",content:"Our advanced AI now calculates wait times with 15% more uncertainty. 'Chaos is the natural order,' explains Lead Queue Engineer.",category:"technology",timestamp:"2025-12-11T11:00:00Z"},{id:6,title:"Queue Dating App Launches Today",content:"Meet other people who are also waiting! Premium feature: See who's ahead of you in line. Perfect for long-distance queue relationships.",category:"lifestyle",timestamp:"2025-12-10T16:30:00Z"},{id:7,title:"Study: Waiting Builds Character",content:"Researchers confirm that standing in virtual queues increases patience by 300%. Character building has never been this inefficient!",category:"science",timestamp:"2025-12-09T08:45:00Z"},{id:8,title:"Queue Real Estate Market Booming",content:"Premium queue positions now selling for $50k. 'Location, location, location,' says realtor. 'Position 42 has excellent wait time potential.'",category:"business",timestamp:"2025-12-08T13:20:00Z"},{id:9,title:"Queue University Offers New Degree",content:"Bachelor's in Applied Waiting Studies now available! Four-year program includes advanced standing, line theory, and queue psychology.",category:"education",timestamp:"2025-12-07T10:10:00Z"},{id:10,title:"Queue Mouse™ Prevents RSI",content:"Ergonomic mouse designed for extended waiting sessions. Features include stress ball attachment and built-in timer for existential contemplation.",category:"product",timestamp:"2025-12-06T17:55:00Z"},{id:11,title:"Queue Insurance Now Available",content:"Protect your position with comprehensive queue insurance! Coverage includes position theft, line cuts, and acts of queue gods.",category:"business",timestamp:"2025-12-05T12:40:00Z"},{id:12,title:"Meditation Queue App Gains Popularity",content:"Find inner peace while waiting with guided meditation. 'Embrace the void of uncertainty,' teaches Queue Guru Master Chen.",category:"wellness",timestamp:"2025-12-04T14:25:00Z"},{id:13,title:"Government Considers Queue Regulations",content:"Congress debates Queue Safety Act after reports of 'extreme waiting fatigue.' Proposed 72-hour maximum queue time called 'unrealistic.'",category:"politics",timestamp:"2025-12-03T09:15:00Z"},{id:14,title:"Queue Speedrun Record Broken",content:"Gamer completes Queue Game in record 0.3 seconds using exploits. 'I accidentally clicked the wrong button,' admits champion.",category:"gaming",timestamp:"2025-12-02T19:30:00Z"},{id:15,title:"Virtual Queue Therapy Sessions Available",content:"Professional therapists now offer support for queue-related trauma. 'It's okay to feel frustrated,' reassures Dr. Waitington.",category:"health",timestamp:"2025-12-01T11:50:00Z"},{id:16,title:"Queue Olympics Announced for 2025",content:"International Queue Olympics to feature standing, waiting, and advanced line-formation events. 'May the longest wait win,' says organizer.",category:"sports",timestamp:"2025-11-30T14:20:00Z"},{id:17,title:"AI Predicts Queue Behavior with 99% Accuracy",content:"Machine learning algorithm can predict when you'll give up waiting. 'Humans are surprisingly predictable,' notes lead researcher.",category:"technology",timestamp:"2025-11-29T16:45:00Z"},{id:18,title:"Queue Cafe Opens in Downtown",content:"New restaurant where you wait to wait for your food. 'We're revolutionizing the dining experience by adding more queues,' says chef.",category:"lifestyle",timestamp:"2025-11-28T10:30:00Z"},{id:19,title:"Queue Etiquette Classes Now Mandatory",content:"Schools nationwide implement queue behavior curriculum. Subjects include 'Advanced Line Cutting Defense' and 'Patience Through Suffering.'",category:"education",timestamp:"2025-11-27T13:15:00Z"},{id:20,title:"Breaking: Queue Length Record Shattered",content:"Virtual queue reaches 2.5 million people waiting for nothing in particular. 'It's about the journey, not the destination,' explains participant.",category:"milestone",timestamp:"2025-11-26T09:40:00Z"},{id:21,title:"Queue Weather Report: Heavy Waiting Expected",content:"Meteorologists predict 73% chance of extended wait times with occasional bursts of forward movement. Umbrella recommended for outdoor queues.",category:"general",timestamp:"2025-11-25T07:25:00Z"},{id:22,title:"Queue Subscription Service Launches",content:"Monthly fee gets you access to premium waiting experiences. 'Why wait for free when you can pay to wait better?' asks CEO.",category:"business",timestamp:"2025-11-24T15:50:00Z"},{id:23,title:"Local Queue Achieves Sentience",content:"Queue #47 reportedly began making its own decisions about who moves forward. 'It's become quite opinionated,' says confused administrator.",category:"science",timestamp:"2025-11-23T12:35:00Z"},{id:24,title:"Queue-to-Queue Transportation Invented",content:"Revolutionary technology allows instant transfer between queues. 'Now you can wait in multiple lines simultaneously!' celebrates inventor.",category:"technology",timestamp:"2025-11-22T18:10:00Z"},{id:25,title:"Queue Gaming Championship Finals Tonight",content:"Top players compete in professional queue navigation. Prize money reaches $50,000 for mastering the art of efficient waiting.",category:"gaming",timestamp:"2025-11-21T20:45:00Z"},{id:26,title:"Queue Anonymous Support Groups Form",content:"'Hi, I'm Bob, and I'm addicted to waiting in lines.' Support groups help people overcome compulsive queue-joining behavior.",category:"health",timestamp:"2025-11-20T11:20:00Z"},{id:27,title:"Queue Fashion Week Showcases Latest Trends",content:"Designers present cutting-edge waiting attire. This season's must-have: ergonomic standing shoes and patience-enhancing jewelry.",category:"lifestyle",timestamp:"2025-11-19T14:55:00Z"},{id:28,title:"Government Declares National Queue Day",content:"Annual celebration honors the noble art of waiting. Citizens encouraged to form spontaneous lines for no particular reason.",category:"politics",timestamp:"2025-11-18T08:30:00Z"},{id:29,title:"Queue Ghost Sightings Increase",content:"Paranormal investigators report spirits of people who died waiting still holding their place in line. 'They're very polite,' notes expert.",category:"general",timestamp:"2025-11-17T22:15:00Z"},{id:30,title:"Queue Yoga Becomes Popular Exercise",content:"New fitness trend combines meditation with standing in line. 'Achieve inner peace while maintaining your position,' teaches instructor.",category:"wellness",timestamp:"2025-11-16T17:40:00Z"},{id:31,title:"Scientific Study: Queues Affect Time Perception",content:"Researchers discover waiting in line literally slows down time. 'Five minutes feels like hours, it's not just in your head,' confirms physicist.",category:"science",timestamp:"2025-11-15T13:25:00Z"},{id:32,title:"Queue Travel Agency Opens Bookings",content:"Vacation packages feature world's most scenic waiting areas. 'Experience the Swiss Alps while standing in line for 8 hours!' advertises brochure.",category:"lifestyle",timestamp:"2025-11-14T10:50:00Z"},{id:33,title:"Queue Archaeology Uncovers Ancient Lines",content:"Scientists discover 5,000-year-old queue preserved in ice. 'They were waiting for something called 'iPhone 1,' notes confused archaeologist.",category:"science",timestamp:"2025-11-13T16:35:00Z"},{id:34,title:"Queue Music Genre Gains Popularity",content:"New musical style captures the rhythm of waiting. Top hit: 'Standing Still (For 3 Hours)' by The Line Dancers reaches #1.",category:"lifestyle",timestamp:"2025-11-12T19:20:00Z"},{id:35,title:"Queue Detective Solves Line-Cutting Mystery",content:"Private investigator specializing in queue crimes catches serial line-cutter. 'Justice served, one position at a time,' declares detective.",category:"general",timestamp:"2025-11-11T12:45:00Z"},{id:36,title:"Queue Banking: Earn Interest While Waiting",content:"Revolutionary financial service pays customers for time spent in queues. 'Turn your waiting time into winning time!' promises bank president.",category:"business",timestamp:"2025-11-10T15:10:00Z"},{id:37,title:"Queue Philosopher Publishes New Theory",content:"'To Wait or Not to Wait: The Queue Dilemma' explores existential meaning of lines. 'We are all just waiting for something,' reflects author.",category:"education",timestamp:"2025-11-09T11:30:00Z"},{id:38,title:"Queue Energy: Harvesting Power from Impatience",content:"Scientists convert frustrated sighs and foot-tapping into electricity. 'Peak energy production occurs around hour 3 of waiting,' reports team.",category:"technology",timestamp:"2025-11-08T14:25:00Z"},{id:39,title:"Queue Cooking Show Premieres Tonight",content:"'Waiting for Gordon' features celebrity chef teaching patience through extended preparation times. 'A watched pot never boils, but we'll wait anyway!'",category:"lifestyle",timestamp:"2025-11-07T18:55:00Z"},{id:40,title:"Queue Time Machine Invented",content:"Device allows you to experience historical queues from different eras. 'Now you can wait like it's 1999!' exclaims time-traveling queue enthusiast.",category:"technology",timestamp:"2025-11-06T21:40:00Z"},{id:41,title:"Queue Whisperer Offers Professional Services",content:"Expert can communicate with angry queues to calm them down. 'Every line has feelings, you just need to listen,' explains queue psychologist.",category:"general",timestamp:"2025-11-05T09:15:00Z"},{id:42,title:"Queue Awards Ceremony Honors Longest Waiters",content:"Annual gala celebrates those who waited the most. Lifetime Achievement Award goes to woman who's been in line since 1987 for concert tickets.",category:"milestone",timestamp:"2025-11-04T20:30:00Z"}];function q(a=5){return I.sort((e,t)=>new Date(t.timestamp)-new Date(e.timestamp)).slice(0,a)}class P{constructor(){this.newsItems=[],this.currentNewsIndex=0,this.newsElement=null,this.rotationInterval=null,this.isActive=!1,this.isPaused=!1}async init(){if(this.newsElement=document.getElementById("news-ticker"),!this.newsElement){console.warn("News ticker element not found");return}this.loadNews(),this.newsItems.length>0?(this.showCurrentNews(),o.news.autoStart&&this.startRotation()):console.log("No news items available"),console.log(`News system initialized with ${this.newsItems.length} items`)}loadNews(){this.newsItems=q(o.news.maxItems),o.ui.showDebugLogs&&console.log(`Loaded ${this.newsItems.length} news items`)}showCurrentNews(){if(!this.newsElement||this.newsItems.length===0)return;const e=this.newsItems[this.currentNewsIndex];o.news.fadeTransition&&this.newsElement.classList.add("news-fading-out"),setTimeout(()=>{this.displayNewsItem(e),o.news.fadeTransition&&(this.newsElement.classList.remove("news-fading-out"),this.newsElement.classList.add("news-fading-in"),setTimeout(()=>{this.newsElement.classList.remove("news-fading-in")},300))},o.news.fadeTransition?200:0)}displayNewsItem(e){if(!e)return;const t=this.getTimeAgo(e.timestamp),i=this.getCategoryIcon(e.category);this.newsElement.innerHTML=`
        ...
        `,document.body.appendChild(e);const t=()=>e.remove();e.querySelector("#confirm-reset").addEventListener("click",()=>{this.resetAllProgress(),t()}),e.querySelector("#cancel-reset").addEventListener("click",t)}async resetAllProgress(){this.queueSimulator.destroy(),localStorage.removeItem("queueSimulatorState"),localStorage.removeItem("queueSimulatorAchievements"),Object.keys(localStorage).forEach(i=>{i.toLowerCase().includes("queue")&&localStorage.removeItem(i)}),this.achievementSystem.resetProgress();const{QueueSimulator:e}=await x(async()=>{const{QueueSimulator:i}=await Promise.resolve().then(()=>S);return{QueueSimulator:i}},void 0,import.meta.url);this.queueSimulator=new e,this.queueSimulator.state.currentQueue=1,this.queueSimulator.state.position=Math.floor(Math.random()*(o.queue.initialPositionMax-o.queue.initialPositionMin))+o.queue.initialPositionMin,this.queueSimulator.state.waitTime=this.queueSimulator.calculateFakeWaitTime(),this.queueSimulator.init(),console.log("Reset complete - Queue level:",this.queueSimulator.state.currentQueue,"Position:",this.queueSimulator.state.position),this.themeManager.setTheme("basic");const t=document.getElementById("achievements-list");t&&(t.innerHTML=""),this.updateAchievementDisplay(),this.updatePositionDisplay(this.queueSimulator.state.position),this.updateWaitTimeDisplay(this.queueSimulator.state.waitTime),this.bindEvents(),console.log("All progress reset")}showConfigPanel(){const e=document.createElement("div");e.style.cssText=`
            ...
            overflow-y: auto;
            box-shadow: 0 10px 30px rgba(0,0,0,0.5);
        `;const t=this.audioManager.isBackgroundMusicPlaying?"ON":"OFF",i=this.audioManager.isBackgroundMusicPlaying?"var(--accent-color)":"var(--text-secondary)",s=localStorage.getItem("musicBlocked")==="true";e.innerHTML=`
            ...
            <div style="margin-bottom: 25px; text-align: center;">
                <div style="margin-bottom: 20px;">
                    ...
                    <div style="font-size: 12px; color: var(--text-secondary); margin-bottom: 10px;">
                        Status: <span style="color: ${i}; font-weight: bold;">${t}</span>
                        ${s?'<br><span style="color: #ff6b6b;">⚠️ Click button to enable music</span>':""}
                    </div>
                </div>
        ...
        `,document.body.appendChild(e);const n=e.querySelector("#music-toggle");n.addEventListener("click",async()=>{if(this.audioManager.isBackgroundMusicPlaying){this.audioManager.pauseBackgroundMusic(),n.innerHTML="🔇 OFF",n.style.background="transparent",n.style.color="var(--accent-color)";const c=e.querySelector('span[style*="font-weight: bold"]');c&&(c.textContent="OFF",c.style.color="var(--text-secondary)")}else if(console.log("User manually requested music - attempting to play"),localStorage.removeItem("musicBlocked"),await this.audioManager.playBackgroundMusic()){n.innerHTML="🎵 ON",n.style.background="var(--accent-color)",n.style.color="var(--primary-bg)";const d=e.querySelector('span[style*="font-weight: bold"]');d&&(d.textContent="ON",d.style.color="var(--accent-color)");const p=e.querySelector('span[style*="#ff6b6b"]');p&&p.remove()}else n.innerHTML="❌ Blocked",setTimeout(()=>{n.innerHTML="🔇 OFF"},2e3);this.audioManager.musicStatusIndicator&&this.audioManager.updateMusicStatus(this.audioManager.musicStatusIndicator),this.audioManager.musicToggleButton&&(this.audioManager.musicToggleButton.style.opacity=this.audioManager.isBackgroundMusicPlaying?"1":"0.5"),setTimeout(()=>{l()},1e3)});const r=e.querySelector("#config-music-volume");let u;r.addEventListener("input",c=>{const d=c.target.nextElementSibling;d.textContent=Math.round(c.target.value*100)+"%",window.updateConfig("audio","backgroundMusicVolume",parseFloat(c.target.value)),this.audioManager.backgroundMusic&&(this.audioManager.backgroundMusic.volume=parseFloat(c.target.value)),clearTimeout(u),u=setTimeout(()=>{l()},2e3)});const l=()=>e.remove();e.querySelector("#close-config").addEventListener("click",l)}bindCheatCodes(){document.addEventListener("keydown",e=>{this.cheatBuffer+=e.key.toLowerCase(),this.cheatBuffer.length>10&&(this.cheatBuffer=this.cheatBuffer.slice(-10));for(const[t,i]of Object.entries(this.cheatCodes))if(this.cheatBuffer.includes(t)){this.cheatBuffer="",i();break}})}activateCheat(){const e=this.queueSimulator.getCurrentQueue();this.queueSimulator.state.position=0,this.updatePositionDisplay(0),this.queueSimulator.updateQueuePosition(),this.showCheatMessage(),console.log(`🎮 CHEAT ACTIVATED: Completed ${e.name} instantly`)}showCheatMessage(){const e=document.createElement("div");e.style.cssText=`
            position: fixed;
            top: 20px;
            right: 20px;
...
`)}`;try{window.open(s,"_blank")}catch{navigator.clipboard.writeText(e).then(()=>{this.showContactInfo(e)}).catch(()=>{this.showContactInfo(e)})}}showContactInfo(e){const t=document.createElement("div");t.style.cssText=`
        ...
        `,document.body.appendChild(t),t.addEventListener("click",()=>{t.remove()})}toggleAudioControls(){if(this.audioControls){const e=this.audioControls.style.display!=="none";this.audioControls.style.display=e?"none":"flex"}else this.audioControls=this.audioManager.createAudioControls()}setupFocusHandling(){window.addEventListener("blur",()=>{var e,t;!this.isPaused&&((t=(e=this.queueSimulator)==null?void 0:e.state)!=null&&t.isActive)&&(console.log("Window lost focus - pausing game"),this.pauseGame())}),window.addEventListener("focus",()=>{this.isPaused&&(console.log("Window gained focus - resuming game"),this.resumeGame())}),document.addEventListener("visibilitychange",()=>{var e,t;document.hidden?!this.isPaused&&((t=(e=this.queueSimulator)==null?void 0:e.state)!=null&&t.isActive)&&(console.log("Tab hidden - pausing game"),this.pauseGame()):this.isPaused&&(console.log("Tab visible - resuming game"),this.resumeGame())})}pauseGame(){this.isPaused=!0,this.wasPlayingMusic=this.audioManager.isBackgroundMusicPlaying,this.wasPlayingMusic&&this.audioManager.pauseBackgroundMusic(),this.queueSimulator&&this.queueSimulator.pause(),this.newsSystem&&this.newsSystem.pause(),this.adSystem&&this.adSystem.pause(),this.showPauseIndicator(),console.log("Game paused")}resumeGame(){this.isPaused=!1,this.wasPlayingMusic&&this.audioManager.playBackgroundMusic(),this.queueSimulator&&this.queueSimulator.resume(),this.newsSystem&&this.newsSystem.resume(),this.adSystem&&this.adSystem.resume(),this.hidePauseIndicator(),console.log("Game resumed")}showPauseIndicator(){this.hidePauseIndicator();const e=document.createElement("div");e.id="pause-indicator",e.style.cssText=`
            position: fixed;
            top: 50%;
            left: 50%;
            transform: translate(-50%, -50%);
        ...
        `,document.body.appendChild(e)}hidePauseIndicator(){const e=document.getElementById("pause-indicator");e&&e.remove()}}document.addEventListener("DOMContentLoaded",()=>{const a=new v;window.gameInstance=a,a.init()});window.QueueGame=v;window.debugAudio=()=>{const a=window.gameInstance;a&&a.audioManager&&(console.log("=== Audio Debug Info ==="),console.log("Audio Manager:",a.audioManager),console.log("Background Music:",a.audioManager.backgroundMusic),console.log("Is Playing:",a.audioManager.isBackgroundMusicPlaying),console.log("Is Muted:",a.audioManager.isMuted),console.log("Volume:",a.audioManager.volume),a.audioManager.backgroundMusic&&console.log("Audio Element State:",{src:a.audioManager.backgroundMusic.src,volume:a.audioManager.backgroundMusic.volume,paused:a.audioManager.backgroundMusic.paused,readyState:a.audioManager.backgroundMusic.readyState,networkState:a.audioManager.backgroundMusic.networkState,error:a.audioManager.backgroundMusic.error}))};window.forcePlayMusic=async()=>{const a=window.gameInstance;if(a&&a.audioManager){console.log("=== Force Playing Music ==="),localStorage.removeItem("musicBlocked");const e=await a.audioManager.playBackgroundMusic();return console.log("Play result:",e),e}};
//# sourceMappingURL=index-BlS-BiNo.js.map
